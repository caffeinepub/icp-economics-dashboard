...
persistent actor {
  ...
  public shared func fetchChartDataFromICPTokensNet(timeframe : ChartTimeframe) : async ChartDataResponse {
    let url = switch (timeframe) {
      ...
      case (#threeMonths) { "https://icptokens.net/api/v1/markets/icp/ohlc?interval=12h&range=90d" };
      case (#sixMonths) { "https://icptokens.net/api/v1/markets/icp/ohlc?interval=1d&range=180d" };
      case (#oneYear) { "https://icptokens.net/api/v1/markets/icp/ohlc?interval=1d&range=365d" };
      case (#all) { "https://icptokens.net/api/v1/markets/icp/ohlc?interval=1d&range=all" };
    };
  ...
  public shared func fetchChartDataFromCoinGecko(timeframe : ChartTimeframe) : async ChartDataResponse {
    let url = switch (timeframe) {
      case (#oneDay) { "https://api.coingecko.com/api/v3/coins/internet-computer/market_chart?vs_currency=usd&days=1" };
      ...
      case (#threeMonths) { "https://api.coingecko.com/api/v3/coins/internet-computer/market_chart?vs_currency=usd&days=90" };
      case (#sixMonths) { "https://api.coingecko.com/api/v3/coins/internet-computer/market_chart?vs_currency=usd&days=180" };
      case (#oneYear) { "https://api.coingecko.com/api/v3/coins/internet-computer/market_chart?vs_currency=usd&days=365" };
      case (#all) { "https://api.coingecko.com/api/v3/coins/internet-computer/market_chart?vs_currency=usd&days=max" };
    };
  ...
  public shared func fetchChartDataFromCoinMarketCap(timeframe : ChartTimeframe) : async ChartDataResponse {
    let url = switch (timeframe) {
      ...
      case (#threeMonths) { "https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/historical?symbol=ICP&interval=12h&count=180" };
      case (#sixMonths) { "https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/historical?symbol=ICP&interval=1d&count=180" };
      case (#oneYear) { "https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/historical?symbol=ICP&interval=1d&count=365" };
      case (#all) { "https://pro-api.coinmarketcap.com/v1/cryptocurrency/quotes/historical?symbol=ICP&interval=1d&count=1000" };
    };
  ...
  public shared func fetchChartDataFromICDashboard(timeframe : ChartTimeframe) : async ChartDataResponse {
    let url = switch (timeframe) {
      ...
      case (#threeMonths) { "https://dashboard.internetcomputer.org/api/v3/metrics/icp_price?interval=12h&range=90d" };
      case (#sixMonths) { "https://dashboard.internetcomputer.org/api/v3/metrics/icp_price?interval=1d&range=180d" };
      case (#oneYear) { "https://dashboard.internetcomputer.org/api/v3/metrics/icp_price?interval=1d&range=365d" };
      case (#all) { "https://dashboard.internetcomputer.org/api/v3/metrics/icp_price?interval=1d&range=all" };
    };
